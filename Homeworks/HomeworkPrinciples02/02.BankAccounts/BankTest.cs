...
namespace _02.BankAccounts
{
    ...
    public class BankSystemTesting
    {
        public static void Main()
        {
            ...
            Console.WriteLine("Loan account balance: {0}", loanAcc.Balance);

            depositAcc.WithdrawAmount(5000);
            Console.WriteLine("Deposit account balance: {0}", depositAcc.Balance);

            Console.WriteLine("Deposit account interest: {0}", depositAcc.CalculateInterestAmount(12));
        }
    }
}
